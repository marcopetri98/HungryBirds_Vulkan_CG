...
//		createDescriptorSetLayout();	// L21
//		createGraphicsPipeline();		// L19 (17, 18, 21)
//		createCommandPool();			// L13
//		createDepthResources();			// L22.1
//		createFramebuffers();			// L22.2
//		createTextureImage();			// New - L23
//		createTextureImageView();		// New - L23
//		createTextureSampler();			// New - L23
//		loadModel();					// L22.4
//		createVertexBuffer();			// L22.4
//		createIndexBuffer();			// L22.4
//		createUniformBuffers();			// L21
//		createDescriptorPool();			// L21
//		createDescriptorSets();			// L21
...
//		appInfo.pApplicationName = "Example 12";
...
//	}
//
//	// Lesson 22.7 --- User interaction
//	//
//	// In most of the simple cases,
//	// here is where you write the logic of your application!
